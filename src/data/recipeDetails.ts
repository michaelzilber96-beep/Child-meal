...
export const RECIPE_DETAILS: Record<string, RecipeDetail> = {
  ...
  okayu: {
    ...
    equipment: ['Small saucepan', 'Blender or fork (for younger babies)'],
  },
  ...
  'gallo-pinto': {
    ...
    instructions: [
      ...
      'Sauté onion and red pepper for 3–4 minutes until very soft.',
  ...
  'congee-chicken': {
    ...
    instructions: [
      ...
      'Cook uncovered for 30–35 minutes, stirring occasionally, until rice breaks down.',
      'Remove chicken, shred finely with two forks, return to pot.',
      'Add ginger if using and stir through.',
  ...
  'semolina-porridge': {
    ...
    instructions: [
      ...
      'Add cinnamon if age-appropriate.',
  ...
  'akara-fritters': {
    ...
    instructions: [
      ...
      'Stir in diced onion.',
      'Preheat oven to 200°C. Grease a mini muffin tray with olive oil.',
    ...
    spiceSaltNote: 'No salt or chilli at any age under 24 months. Onion provides enough flavour.',
  ...
  'cottage-cheese-apple': {
    ...
    ingredients: [
      ...
      { quantity: '1', unit: 'small', item: 'sweet apple (such as Fuji or Gala), peeled and finely grated' },
      { quantity: '1', unit: 'tsp', item: 'olive oil' },
    ],
    instructions: [
  ...
  'millet-porridge': {
    ...
    spiceSaltNote: 'No salt. No cinnamon for under 10 months. Millet has a mild nutty flavour that babies enjoy without any seasoning.',
  ...
  'dal-lentil-curry': {
    ...
    instructions: [
      'Heat oil in a small saucepan, sauté onion for 3 minutes until soft.',
  ...
  koshari: {
    ...
    spiceSaltNote: 'No salt. Use only unsalted passata. Cumin safe from 12 months.',
  ...
  omurice: {
    ...
    instructions: [
      'Sauté vegetables in half the butter for 3 minutes until very soft.',
      ...
      'Add a small dot of ketchup if age-appropriate.',
    ],
    prepMinutes: 5,
    cookMinutes: 10,
    ...
    spiceSaltNote: 'No salt. No ketchup for under 12 months (high sodium). For 12 months+ a very small amount of unsalted ketchup is acceptable.',
  ...
  schnitzel: {
    ...
    instructions: [
      ...
      'Cool, slice into strips or small pieces before serving.',
    ],
    prepMinutes: 10,
    cookMinutes: 20,
    ...
    spiceSaltNote: 'No salt. No pepper for under 12 months. Use unsalted breadcrumbs.',
  ...
  'red-lentil-soup': {
    ...
    instructions: [
      ...
      'Add cumin and lemon juice if age-appropriate.',
    ...
    spiceSaltNote: 'No salt. Cumin and lemon safe from 10 months. Lemon juice helps with iron absorption.',
  ...
  'chicken-tagine': {
    ...
    spiceSaltNote: 'No salt. Cinnamon and ginger safe from 12 months. For 10–12 months serve without spices.',
  ...
  'fish-rice-thai': {
    ...
    spiceSaltNote: 'No salt. No fish sauce or soy sauce at any age. Fish is naturally flavourful enough.',
  ...
  'vegetable-biryani': {
    ...
    instructions: [
      ...
      'Add mild curry powder if age-appropriate.',
  ...
  'salmon-mash': {
    ...
    instructions: [
      ...
      'Meanwhile, bake salmon at 180°C for 12 minutes until cooked through.',
      'Check salmon carefully for any bones.',
      'Mash potato with milk and butter until smooth.',
      'Flake salmon finely and fold into mash.',
      'Add dill if age-appropriate.',
    ],
    prepMinutes: 5,
    cookMinutes: 20,
    ...
    spiceSaltNote: 'No salt. No dill for under 12 months. Always check salmon very carefully for bones.',
  ...
  'black-bean-taco-bowl': {
    ...
    instructions: [
      ...
      'Add lime juice if age-appropriate.',
  ...
  'tofu-stir-fry': {
    ...
    ingredients: [
      ...
      { quantity: '1', unit: 'tsp', item: 'low-sodium soy sauce (12 months+ only, or use coconut aminos)' },
    ],
    instructions: [
      ...
      'Add soy sauce or coconut aminos if age-appropriate.',
    ...
    spiceSaltNote: 'No soy sauce for under 12 months — use coconut aminos. Sesame oil is fine from 8 months in small quantities.',
  ...
  'chickpea-stew': {
    ...
    instructions: [
      ...
      'Add paprika if age-appropriate.',
    ...
    spiceSaltNote: 'No salt. No paprika for under 12 months. Paprika is a mild spice safe from 12 months.',
  ...
  shakshuka: {
    ...
    instructions: [
      'Heat olive oil in a small pan, sauté pepper for 4 minutes.',
  ...
  'sabich-salad': {
    ...
    instructions: [
      'Roast aubergine cubes at 200°C with olive oil for 25 minutes until very soft.',
  ...
  'greek-salad-feta': {
    ...
    spiceSaltNote: 'Feta is naturally salty — this dish should not have any additional salt added. Limit to small portions.',
  ...
  'sweet-potato-bean-puree': {
    ...
    spiceSaltNote: 'No salt needed. Sweet potato provides natural sweetness. No spices required.',
  ...
  mujaddara: {
    ...
    instructions: [
      ...
      'Meanwhile caramelise onion in olive oil over low heat for 20 minutes.',
      'Stir half the onion through the lentil rice mixture.',
      'Top with remaining golden onion.',
      'For under 12 months: remove onion topping and mash mixture.',
    ],
    prepMinutes: 5,
    cookMinutes: 35,
  ...
  ratatouille: {
    ...
    instructions: [
      ...
      'Stir in thyme if age-appropriate.',
  ...
  'carrot-ginger-soup': {
    ...
    ingredients: [
      ...
      { quantity: '1', unit: 'small', item: 'potato, peeled and diced (for creaminess)' },
  ...
  'baked-fish-lemon': {
    ...
    instructions: [
      ...
      'Add fresh herbs if age-appropriate.',
    ...
    spiceSaltNote: 'No salt. Always check for bones twice. Lemon juice is safe from 10 months. Fresh herbs safe from 12 months.',
  ...
  'pumpkin-coconut-curry': {
    ...
    instructions: [
      ...
      'Add coriander if age-appropriate.',
    ...
    spiceSaltNote: 'No salt. Turmeric safe from 6 months. Coriander safe from 12 months. Coconut milk provides enough richness.',
  ...
  'beef-vegetable-stew': {
    ...
    spiceSaltNote: 'No salt. No pepper for under 12 months. Use only unsalted stock. Tomato paste provides depth without seasoning.',
  ...
  'avocado-corn-puree': {
    ...
    instructions: [
      ...
      'Blend corn until smooth — strain if needed for young babies.',
    ...
    spiceSaltNote: 'No salt. No lime for under 10 months. Avocado provides all the fat and flavour needed.',
  ...
  'tofu-miso-soup': {
    ...
    ingredients: [
      ...
      { quantity: '1', unit: 'tbsp', item: 'dried wakame seaweed, soaked and chopped (optional, 12 months+)' },
    ],
    instructions: [
      ...
      'Add tofu cubes and soak wakame if using.',
      'Return to very low heat for 2 minutes to warm tofu through.',
      'For under 12 months: skip wakame, serve just tofu and broth.',
    ],
    prepMinutes: 5,
    cookMinutes: 5,
  ...
  'egg-fried-rice-dinner': {
    id: 'egg-fried-rice',
    ingredients: [
      { quantity: '80', unit: 'g', item: 'cooked rice' },
      { quantity: '2', unit: 'large', item: 'eggs' },
      { quantity: '30', unit: 'g', item: 'peas' },
      { quantity: '1', unit: 'tsp', item: 'sesame oil' },
      { quantity: '1', unit: 'tsp', item: 'coconut aminos' },
    ],
    instructions: [
      'See egg-fried-rice entry above — same recipe used as dinner.',
    ],
    prepMinutes: 3,
    cookMinutes: 7,
    nutritionPerServing: { kcal: 200, proteinG: 8, carbsG: 30, fatG: 7 },
    servingSizeByAge: {
      months4to6: 'Not suitable',
      months7to9: 'Not suitable',
      months10to12: '5–6 tablespoons',
      months12to24: 'Full portion',
    },
    spiceSaltNote: 'See egg-fried-rice entry.',
